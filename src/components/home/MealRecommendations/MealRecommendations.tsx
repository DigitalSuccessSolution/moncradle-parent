      ...
      <div className="flex items-center justify-between mb-3 sm:mb-5 md:mb-6 gap-2">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs sm:text-sm md:text-base text-gray-500 font-light mt-0.5 hidden md:block">
            Healthy and tasty food options tailored for your baby.
          </p>
        </div>
        <Link href="/nutrition/meal-plans" className="text-xs md:text-sm font-medium text-[var(--color-primary)] flex items-center gap-0.5 group shrink-0 whitespace-nowrap">
