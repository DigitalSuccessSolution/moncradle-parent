export function NewsletterSection() {
  return (
    <section className="bg-white border-t border-[var(--color-border)] py-8 md:py-10 flex flex-col md:flex-row items-center justify-between gap-6">
      <div>
        <h3 className="font-semibold text-lg text-gray-900 mb-1">Never Miss an Update!</h3>
      ...
      <div className="flex w-full md:w-auto gap-2">
        ...
        />
        <button className="bg-[var(--color-primary)] text-white px-6 py-2.5 rounded-xl font-semibold shadow-md shadow-[var(--color-primary)]/20 hover:bg-[var(--color-primary-light)] transition-colors text-xs whitespace-nowrap">
          Subscribe
        </button>
      </div>
    </section>
