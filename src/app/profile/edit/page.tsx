...
import { ChevronLeft, Camera, User, Mail, Phone, MapPin, CheckCircle2, UserCircle } from "lucide-react";
      ...
      <main className="max-w-4xl mx-auto px-0 sm:px-6 md:px-8 mt-0 md:mt-6">
        ...
        <div className="bg-white shadow-sm p-6 md:p-12">
          ...
          <form onSubmit={handleSave} className="space-y-6 md:space-y-8 max-w-2xl mx-auto">
            ...
            <div className="space-y-2">
              <label className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider">Delivery Address</label>
              <div className="relative">
                ...
                <textarea 
                  ...
                  className="w-full pl-11 pr-4 py-4 bg-white border border-gray-200 rounded-xl text-[15px] font-semibold text-gray-900 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent transition-all resize-none"
                ></textarea>
              </div>
            </div>
